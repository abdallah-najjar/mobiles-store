<?php $__env->startSection('title', 'موبايلات المواصي - وجهتك الموثوقة للهواتف الذكية في غزة'); ?>
                    ...
                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('brands.show', $brand)); ?>"
                            ...
                            <h4
                                ...
                                <?php echo e($brand->name); ?></h4>
                            <p class="text-xs text-gray-500 hidden sm:block"><?php echo e($brand->active_products_count); ?> منتج</p>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('categories.show', $category)); ?>"
                            ...
                            <div class="relative z-10 h-full flex flex-col justify-end p-3 sm:p-4 lg:p-6 text-white">
                                <h3 class="text-sm sm:text-lg lg:text-xl font-bold mb-1"><?php echo e($category->name); ?></h3>
                                <p class="text-xs sm:text-sm opacity-90"><?php echo e($category->active_products_count); ?> منتج</p>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\mobiles-store\resources\views/home.blade.php ENDPATH**/ ?>