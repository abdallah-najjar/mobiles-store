...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <p class="text-gray-600 text-sm sm:text-base">إدارة تصنيفات المنتجات</p>
                                ...
                                <div class="flex items-center">
                                    <?php if($category->image): ?>
                                        <img src="<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>"
                                            class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg object-cover bg-gray-100 ml-3 lg:ml-4 flex-shrink-0">
                                    <?php else: ?>
                                        <div
                                    ...
                                    <?php endif; ?>
                                    <div class="min-w-0">
                                        <h4 class="font-medium text-gray-800 text-sm truncate"><?php echo e($category->name); ?></h4>
                                        <p class="text-xs text-gray-500 truncate"><?php echo e($category->slug); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 lg:px-6 py-4 text-gray-700 text-sm"><?php echo e($category->products_count); ?> منتج</td>
                            <td class="px-4 lg:px-6 py-4">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="font-medium text-gray-800 truncate"><?php echo e($category->name); ?></h4>
                        <p class="text-xs text-gray-500 truncate"><?php echo e($category->slug); ?></p>
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <?php endif; ?>
                            <span class="text-xs text-gray-500"><?php echo e($category->products_count); ?> منتج</span>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-end gap-3 mt-3 pt-3 border-t">
                    <a href="<?php echo e(route('admin.categories.edit', $category)); ?>"
                        class="text-gray-500 hover:text-green-600 p-2" title="تعديل">
                        <i class="fas fa-edit"></i>
                    </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\mobiles-store\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>