...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?> - موبايلات المواصي</title>
        ...
        <aside id="sidebar"
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="p-4 border-b border-gray-800 flex items-center justify-between">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-2 space-x-reverse">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>"
                                class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.products.index')); ?>"
                                class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition <?php echo e(request()->routeIs('admin.products.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.brands.index')); ?>"
                                class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition <?php echo e(request()->routeIs('admin.brands.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.categories.index')); ?>"
                                class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.settings.index')); ?>"
                                class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-gray-800 text-white' : ''); ?>">
            ...
            <header class="bg-white shadow-sm sticky top-0 z-30">
                <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-lg sm:text-xl font-semibold text-gray-800"><?php echo $__env->yieldContent('page-title', 'لوحة التحكم'); ?></h1>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2 sm:space-x-4 space-x-reverse">
                        <span
                            class="text-gray-600 text-sm sm:text-base hidden sm:inline"><?php echo e(auth()->user()->name); ?></span>
                        <div
...
<?php /**PATH C:\laragon\www\mobiles-store\resources\views/layouts/admin.blade.php ENDPATH**/ ?>