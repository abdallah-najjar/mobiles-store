<?php $__env->startSection('title', 'اتصل بنا - موبايلات المواصي'); ?>
                            ...
                            <form action="<?php echo e(route('contact.submit')); ?>" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <select name="subject" required
                                            ...
                                            <option value="استفسار عن منتج"
                                                <?php echo e(old('subject') == 'استفسار عن منتج' ? 'selected' : ''); ?>>استفسار عن منتج
                                            </option>
                                            <option value="حالة الطلب"
                                                <?php echo e(old('subject') == 'حالة الطلب' ? 'selected' : ''); ?>>حالة الطلب</option>
                                            <option value="الدعم الفني"
                                                <?php echo e(old('subject') == 'الدعم الفني' ? 'selected' : ''); ?>>الدعم الفني</option>
                                            <option value="أخرى" <?php echo e(old('subject') == 'أخرى' ? 'selected' : ''); ?>>أخرى
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="message" rows="5" required
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                        placeholder="كيف يمكننا مساعدتك؟"><?php echo e(old('message')); ?></textarea>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\mobiles-store\resources\views/contact.blade.php ENDPATH**/ ?>