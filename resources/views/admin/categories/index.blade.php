                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 lg:px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    @endif
                                    <div class="min-w-0">
                                        <h4 class="font-medium text-gray-800 text-sm truncate">{{ $category->name }}</h4>
                                        <p class="text-xs text-gray-500 truncate">{{ $category->slug }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 lg:px-6 py-4 text-gray-700 text-sm">{{ $category->products_count }} منتج</td>
                            <td class="px-4 lg:px-6 py-4">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="font-medium text-gray-800 truncate">{{ $category->name }}</h4>
                        <p class="text-xs text-gray-500 truncate">{{ $category->slug }}</p>
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            @endif
                            <span class="text-xs text-gray-500">{{ $category->products_count }} منتج</span>
                        </div>
                    </div>
                </div>
