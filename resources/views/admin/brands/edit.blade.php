                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">{{ old('description', $brand->description) }}</textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">شعار العلامة التجارية</label>
                        <div id="logo-preview" class="mb-3 {{ $brand->logo ? '' : 'hidden' }}">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="url" name="logo" value="{{ old('logo', $brand->logo) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
